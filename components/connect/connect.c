...
void WIFI_event_handler(void *event_handler_arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
    switch (event_id)
    {
    case WIFI_EVENT_STA_START: // Connecting to forcefully to the AP network.
    {
    ...
    case WIFI_EVENT_STA_CONNECTED: // ESP32 connected successfully to the WIFI network.
    {
        ESP_LOGI(TAG, "connected");
    }
    break;

    case WIFI_EVENT_STA_DISCONNECTED: // ESP32 Disconnected from the AP network
    {
